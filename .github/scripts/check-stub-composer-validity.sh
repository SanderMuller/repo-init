...
for stub_dir in stubs/laravel-package stubs/laravel-package-spatie stubs/php-package stubs/phpstan-extension stubs/rector-extension stubs/filament-plugin stubs/nova-tool; do
