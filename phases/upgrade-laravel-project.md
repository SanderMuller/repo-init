...
1. Raise `require.php` to `^8.5` in `composer.json` — `laravel-project` floors at the newest stable PHP, not the package floor (see `$REPO_INIT_HOME/references/version-defaults.md` "PHP").
