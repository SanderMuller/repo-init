...
> **Prerequisite**: `sandermuller/package-boost` must support `--scope=user` sync. This is a known dependency — see [Open Question #3 in SPEC.md](SPEC.md). Until that ships, run `vendor/bin/testbench package-boost:sync` manually after install.
